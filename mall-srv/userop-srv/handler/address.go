...
func (*UserOpServer) GetAddressList(ctx context.Context, req *pb.AddressRequest) (*pb.AddressListResponse, error) {
	var addresses []model.Address
	var rsp pb.AddressListResponse
	var addressResponse []*pb.AddressResponse
	...
	for _, address := range addresses {
		addressResponse = append(addressResponse, &pb.AddressResponse{
			Id:           address.ID,
			UserId:       address.User,
...
func (*UserOpServer) CreateAddress(ctx context.Context, req *pb.AddressRequest) (*pb.AddressResponse, error) {
	...
	return &pb.AddressResponse{Id: address.ID}, nil
}

func (*UserOpServer) DeleteAddress(ctx context.Context, req *pb.AddressRequest) (*emptypb.Empty, error) {
...
func (*UserOpServer) UpdateAddress(ctx context.Context, req *pb.AddressRequest) (*emptypb.Empty, error) {
	var address model.Address
