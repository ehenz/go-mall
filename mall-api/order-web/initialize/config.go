...
func InitConfig(debug bool) {
	...
	configFileName = "order-web/nacos-dev.yaml"
	if debug == false {
		configFileName = "order-web/nacos-pro.yaml"
	}
	v := viper.New()
...
//func InitConfig(debug bool) {
//	var configFileName string
//	configFileName = "order-web/config-debug.yaml"
//	if debug == false {
//		configFileName = "order-web/config-pro.yaml"
//	}
//	v := viper.New()
//	v.SetConfigFile(configFileName)
//	_ = v.ReadInConfig()
