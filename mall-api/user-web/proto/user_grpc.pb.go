...
type UserClient interface {
	...
	CreatUser(ctx context.Context, in *CreatRequest, opts ...grpc.CallOption) (*UserInfoResponse, error)
...
func (c *userClient) CreatUser(ctx context.Context, in *CreatRequest, opts ...grpc.CallOption) (*UserInfoResponse, error) {
	out := new(UserInfoResponse)
	err := c.cc.Invoke(ctx, "/User/CreatUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserServer) CreatUser(context.Context, *CreatRequest) (*UserInfoResponse, error) {
...
func _User_CreatUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/User/CreatUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).CreatUser(ctx, req.(*CreatRequest))
	}
	return interceptor(ctx, in, info, handler)
}
