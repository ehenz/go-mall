...
func InitConfig(debug bool) {
	...
	configFileName = "userop-web/nacos-dev.yaml"
	if debug == false {
		configFileName = "userop-web/nacos-pro.yaml"
	}
	v := viper.New()
...
//func InitConfig(debug bool) {
//	var configFileName string
//	configFileName = "userop-web/config-debug.yaml"
//	if debug == false {
//		configFileName = "userop-web/config-pro.yaml"
//	}
//	v := viper.New()
//	v.SetConfigFile(configFileName)
//	_ = v.ReadInConfig()
